...
const Layout = () => {
  ...
  const isDemoUser = user?.id === "demo-user-00000000-0000-0000-0000-000000000001";
    ...
    <div className="min-h-screen flex">
      ...
      <aside className="hidden md:flex w-64 bg-primary text-primary-foreground flex-col fixed h-full z-30">
        ...
        <div className="p-3 border-t border-sidebar-border">
          {isDemoUser && (
            <div className="mb-2 px-3 py-1.5 rounded-lg bg-yellow-400/20 text-yellow-200 text-xs font-semibold text-center">
              Demo Mode
            </div>
          )}
          <Link
